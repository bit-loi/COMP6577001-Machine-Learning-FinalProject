...
.pill-risk { display:inline-flex;align-items:center;gap:6px;padding:6px 16px;border-radius:20px;font-size:0.85rem;font-weight:800;text-transform:uppercase;letter-spacing:0.05em; }
.risk-high { background:#fef2f2;color:#dc2626;border:1.5px solid #fecaca; }
.risk-medium { background:#fefce8;color:#ca8a04;border:1.5px solid #fde047; }
.risk-low { background:#f0fdf4;color:#15803d;border:1.5px solid #86efac; }
.prob-bar-wrap { height:12px;background:#f1f5f9;border-radius:6px;overflow:hidden;margin-top:8px; }
.prob-bar { height:100%;border-radius:6px;transition:width 1.2s cubic-bezier(.34,1.56,.64,1); }
.feature-card { background:#f8fafc;border:1px solid #e2e8f0;border-radius:10px;padding:14px;text-align:center; }
.feature-val { font-size:1.25rem;font-weight:800;color:#0f172a; }
.feature-lbl { font-size:0.68rem;color:#94a3b8;font-weight:600;text-transform:uppercase;letter-spacing:0.05em;margin-top:4px; }
</style>
        ...
        <form id="churn-form">
            ...
            <div style="margin:20px 0;">
                ...
                <div style="display:flex;gap:8px;flex-wrap:wrap;">
                    <button type="button" onclick="loadPreset('loyal')" style="padding:6px 14px;background:#f0fdf4;color:#15803d;border:1.5px solid #86efac;border-radius:8px;font-size:0.75rem;font-weight:700;cursor:pointer;">✓ Loyal Customer</button>
                    <button type="button" onclick="loadPreset('atRisk')" style="padding:6px 14px;background:#fefce8;color:#854d0e;border:1.5px solid #fde047;border-radius:8px;font-size:0.75rem;font-weight:700;cursor:pointer;">⚠ At Risk Customer</button>
                    <button type="button" onclick="loadPreset('churned')" style="padding:6px 14px;background:#fef2f2;color:#dc2626;border:1.5px solid #fca5a5;border-radius:8px;font-size:0.75rem;font-weight:700;cursor:pointer;">✗ Likely Churned</button>
                </div>
            </div>
        ...
        <div class="table-card">
            ...
            <div style="display:flex;flex-direction:column;gap:8px;font-size:0.78rem;">
                <div style="display:flex;align-items:center;gap:10px;padding:8px 12px;background:#fef2f2;border-radius:8px;">
                    ...
                    <div><strong>High Risk</strong> — Probabilitas ≥ 75%</div>
                </div>
                <div style="display:flex;align-items:center;gap:10px;padding:8px 12px;background:#fefce8;border-radius:8px;">
                    ...
                    <div><strong>Medium Risk</strong> — Probabilitas 45% – 74%</div>
                </div>
                <div style="display:flex;align-items:center;gap:10px;padding:8px 12px;background:#f0fdf4;border-radius:8px;">
                    ...
                    <div><strong>Low Risk</strong> — Probabilitas &lt; 45%</div>
                </div>
            </div>
        </div>
...
document.getElementById('churn-form').addEventListener('submit', async function(e) {
    ...
    try {
        ...
        const colors = { High: { bg:'#dc2626', bar:'#ef4444', pill:'risk-high', action:'background:#fef2f2;color:#dc2626;border:1.5px solid #fecaca;' },
                         Medium:{ bg:'#ca8a04', bar:'#eab308', pill:'risk-medium', action:'background:#fefce8;color:#ca8a04;border:1.5px solid #fde047;' },
                         Low:   { bg:'#15803d', bar:'#22c55e', pill:'risk-low', action:'background:#f0fdf4;color:#15803d;border:1.5px solid #86efac;' } };
        ...
        document.getElementById('result-risk-pill').innerHTML = `<span class="pill-risk ${c.pill}">${risk} Risk</span>`;
